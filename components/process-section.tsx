...
export function ProcessSection() {
  return <section data-process-layout="sticky-list" className="bg-paper" aria-labelledby="process-heading"><div className="page-shell section-space grid gap-14 lg:grid-cols-[.7fr_1.3fr] lg:gap-24">
    <div className="self-start lg:sticky lg:top-32"><MotionReveal><p className="eyebrow brand-rule text-stone">Our process</p><h2 id="process-heading" className="display mt-7 text-5xl leading-[.96] md:text-6xl">From consultation to resolution, handled with clarity.</h2><p className="mt-7 max-w-md leading-7 text-stone">A thoughtful legal process starts with a clear view of the matter, then moves forward with disciplined preparation and practical direction.</p></MotionReveal></div>
