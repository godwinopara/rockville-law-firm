...
export default function About() {
  return <>
    <div data-about-section="hero"><EditorialHero eyebrow="About Rockville" title="A practice built for clear, consequential decisions." description="We combine professional standards, commercial awareness, and practical thinking to serve the legal and business needs of our clients." image="/images/lagos-office.jpg" imageAlt="Refined contemporary architecture" slides={[{ image: "/images/lagos-office.jpg", alt: "Refined contemporary architecture" }, { image: "/images/firm/conference-library-wide.jpg", alt: "Rockville LP conference room and legal library" }, { image: "/images/firm/legal-library-wide.jpg", alt: "Rockville LP legal library" }]} primaryLabel="Book consultation" secondaryLabel="Our services" /></div>
